...
<script>
    function initialize() {
        var mapOptions = {
            zoom: 9,
            scrollwheel: false,
            center: new google.maps.LatLng(34.12, -118.40),
...
<div class="map-module slideImage hide-tablet">
    <h5 class="tab">LA Clients</h5>
    <div id="map-canvas"></div>
    <a href="/clients">
        <button class="white-bg mod-fixed">View clients</button>
    </a>
</div>